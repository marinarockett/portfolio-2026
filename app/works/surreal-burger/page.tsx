  ...
  return (
    <ProjectPage
      project={{
        ...
        solution:
          "We designed a streamlined prompt-to-image experience with guardrails that kept outputs on-brand. A curated set of style prompts helped guide users toward higher-quality results, while the UI emphasized shareability — each generated image came pre-framed with McDonald's branding for instant social sharing. The backend pipeline used fine-tuned diffusion models trained on brand-appropriate visual references, ensuring every output felt distinctly "Surreal Burger" regardless of the input prompt.",
        related: [
